...
#
# P3_EMA.tcl: Tcl script for re-creating project 'vivado_project'
#
...
set files [list \
 [file normalize "${origin_dir}/src/vsrc/axis_bitflip.v"] \
 [file normalize "${origin_dir}/src/vsrc/axis_ema.sv"] \
 [file normalize "${origin_dir}/src/vsrc/axis_ema.v"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/src/vsrc/axis_ema.sv"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "design_fpga_wrapper" -objects $obj
...
# Set 'sim_bitflip' fileset object
...
# Set 'sim_bitflip' fileset file properties for remote files
set file "$origin_dir/src/vtests/sim_bitflip/tb_bitflip.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_bitflip] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj


# Set 'sim_bitflip' fileset file properties for local files
# None

# Set 'sim_bitflip' fileset properties
set obj [get_filesets sim_bitflip]
set_property -name "hbs.configure_design_for_hier_access" -value "1" -objects $obj
set_property -name "top" -value "tb_bitflip" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_lib" -value "xil_defaultlib" -objects $obj

# Create 'sim_ema' fileset (if not found)
if {[string equal [get_filesets -quiet sim_ema] ""]} {
  create_fileset -simset sim_ema
}

# Set 'sim_ema' fileset object
...
# Set 'sim_ema' fileset file properties for remote files
set file "$origin_dir/src/vtests/sim_ema/tb_ema.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_ema] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj


# Set 'sim_ema' fileset file properties for local files
# None

# Set 'sim_ema' fileset properties
set obj [get_filesets sim_ema]
set_property -name "hbs.configure_design_for_hier_access" -value "1" -objects $obj
set_property -name "top" -value "tb_ema" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_lib" -value "xil_defaultlib" -objects $obj
...
# End of cr_bd_design_fpga()
cr_bd_design_fpga ""
set_property REGISTERED_WITH_MANAGER "1" [get_files design_fpga.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files design_fpga.bd ] 
...
# Proc to create BD bd_bitflip
proc cr_bd_bd_bitflip { parentCell } {
# The design that will be created by this Tcl proc contains the following 
# module references:
# axis_bitflip
